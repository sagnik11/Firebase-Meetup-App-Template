# Contributing to the Firebase Meetup App Template
...
As contributors and maintainers of the Firebase Meetup App Template project, we pledge to respect everyone who contributes by posting issues, updating documentation, submitting pull requests, providing feedback in comments, and any other activities.

Communication through any of WorqHat's channels (GitHub, StackOverflow, Google+, Twitter, etc.) must be constructive and never resort to personal attacks, trolling, public or private harassment, insults, or other unprofessional conduct.
...
If you are subject to or witness unacceptable behavior, or have any other concerns, please drop us a line at support@worqhat.com.

## <a name="question"></a> Got a Question or Problem?

If you have questions about how to use the boilerplate shoot us a DM on Twitter [WorqHat on Twitter](https://twitter.com/worqhat).  We are also available on GitHub issues.
...
* Search [GitHub](https://github.com/sagnik11/Firebase-Meetup-App-Template/pulls) for an open or closed Pull Request
